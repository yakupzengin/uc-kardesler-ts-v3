import React, { useState, useEffect } from 'react'; // useState ve useEffect Hooks'unu ekledik
import "./ReasonPart.css"

const NavigateServices = () => {
  const [isMobile, setIsMobile] = useState(window.innerWidth < 770); // Ekranın mobil olup olmadığını kontrol etmek için bir durum değişkeni ekledik

  useEffect(() => {
    window.addEventListener("resize", () => { // Pencere boyutu değiştiğinde durum değişkenini güncelliyoruz
