...
const Location = () => {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      setLoading(false);
    }, 1000); // 1 saniye sonra yükleme durumunu false olarak ayarla

    return () => clearTimeout(timer); // bileşen temizlendiğinde zamanlayıcıyı temizle ( önemli nokta )
  }, []);
    ...
    <div className="location-page">
      ...
      <div className="map">
        {loading ? (
          ...
          // <iframe
          //   title="location"
          //   src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d30000!2d29.0000000!3d41.0000000!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNDDCsDAwJzAwLjAiTiAyOMKwMDAnMDAuMCJF!5e0!3m2!1sen!2str!4v1632766049408!5m2!1sen!2str"
          //   width="600"
          //   height="450"
          //   allowFullScreen=""
          //   loading="lazy"
